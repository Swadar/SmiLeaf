...
* ### <details> <summary>Capteur d'humidité dans le sol -> MSMS</summary> * **Voltage :** 2.5V - 7.0V  * **Sortie :** Analogique (Inversée)  * **Sonde :** Capacitive & Double face  * **Extras :** Port Grove, LED indicateurs, Mode économie d'énergie
  </details>
